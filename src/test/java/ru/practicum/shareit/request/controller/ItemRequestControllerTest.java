...
class ItemRequestControllerTest {
    ...
    void add() throws Exception {
        ...
        verify(itemRequestService, times(1))
                .save(itemRequestDto, itemRequest.getUser().getId());
    }
    ...
    void findAll() throws Exception {
        ...
        when(itemRequestService.findAll(itemRequest.getUser().getId()))
                .thenReturn(result);
    ...
    void findById() throws Exception {
        ...
        ItemRequestDtoWithItems itemRequestDtoWithItems = itemRequestMapper
                .toItemRequestDtoWithItems(itemRequest);
        result.add(itemRequestDtoWithItems);
        when(itemRequestService.findAllRequests(itemRequest.getUser().getId(),
                0, 20))
                .thenReturn(result);
    ...
    void findByRequestId() throws Exception {
        ItemRequestDtoWithItems itemRequestDtoWithItems = itemRequestMapper
                .toItemRequestDtoWithItems(itemRequest);
        when(itemRequestService.findByRequestId(itemRequest.getUser().getId(), itemRequest.getId()))
